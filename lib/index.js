...
module.exports = function (mini) {
	...
	mini.use(express.static( path.resolve( '/home/'+ miniuser.system.root +'/Gorilla-UI/client' ))); 
    ...
    mini.get( '/*', function (req, res) {
        res.sendFile( path.join('/home/'+ miniuser.system.root +'/Gorilla-UI/client/index.html' ));
    });
};
